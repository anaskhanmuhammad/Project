...
const ApexChart = ({ titleText, yTitle, color, hoverTitle, data, showSeperateWindow }) => {
  //   const dates = [
  //     /* Your dates data here */
  //   ];
  // console.log("x", data);
  // const dates = [
  //   [1327359600000, 30.95],
  ...
  const options = {
    chart: {
      ...
      events: {
        click: () => showSeperateWindow(titleText, yTitle, color, hoverTitle, data)
      },
    },
    colors: [color, "#cc2d6f"],
    dataLabels: {
